...
namespace LelangService.IntegrationTests.Utils
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<LelangDbContext>));
        ...
        public static void EnsureCreated<T>(this IServiceCollection services)
        {
            ...
            var db = scopedServices.GetRequiredService<LelangDbContext>();
