...
namespace LelangService.Data
{
    public class DbInitializer
    {
        public static void InitDb(WebApplication app)
        {
            ...
            SeedData(scope.ServiceProvider.GetService<LelangDbContext>());
        }

        private static void SeedData(LelangDbContext context)
        {
            context.Database.Migrate();

            if (context.lelangs.Any())
            {
                Console.WriteLine("Data sudah ada");
                return;
            }

            var lelangs = new List<Entities.Lelang>
           {
               	    // 1 Ford GT
            new Lelang
            {
            ...
            new Lelang
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                EndedAt = DateTime.UtcNow.AddDays(30),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Lelang
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                EndedAt = DateTime.UtcNow.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Lelang
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                EndedAt = DateTime.UtcNow.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Lelang
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                EndedAt = DateTime.UtcNow.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Lelang
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                EndedAt = DateTime.UtcNow.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Lelang
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                EndedAt = DateTime.UtcNow.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
            ...
            context.lelangs.AddRange(lelangs);
            context.SaveChanges();
        }
    }
}
